...
class DataCollection():
    ...
    def producerFunctions(self,args ):
        ...
        for i in range(100):
            if(i%3==0):
                if count==3:
                   ...
                   # commented by mayank: args.lock.acquire()
                    args.lock.acquire(shared=False)
                    try:
        ...
        for company in args.stockHash.iterkeys():
            for node in args.stockHash[company]:
                print str(node.price) +","
